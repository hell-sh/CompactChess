...
public class DefaultPieceStyle extends PieceStyle
{
	public static final DefaultPieceStyle instance = new DefaultPieceStyle();

	@Override
	public String getSVG(Color color, PieceType type)
	{
		switch(type)
		{
			case PAWN:
